...
def cloudlab_remote(ctx, debug=True):
    ...
    solid_step_length = int(os.environ.get('NARWHAL_SIGMA', '2'))
    solid_step_number = int(os.environ.get('NARWHAL_KAPPA', '1'))
    solid_reference = int(os.environ.get('NARWHAL_REF', '3'))
