...
TARGET_RATE = 30_000
OUTPUT_PATHS = [
    Path("results/comparisons/network_workload_combo_metrics_30k.pdf"),
    Path("results/comparisons/network_workload_combo_metrics_30k.png"),
]
FIXED_BATCHES = {
...
def _collect_points(network_label: str, workload_dir: str, workload_label: str) -> list[SummaryPoint]:
    root = Path("results") / network_label / workload_dir
